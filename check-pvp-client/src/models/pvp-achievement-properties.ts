/**
 * This file should be converted into JSON since it's purely data
 */
...
export const PVP_ACHIEVEMENT_PROPERTIES: PvpAchievementProperty = {
        5267: {
            ...
            icon: 'achievement_arena_3v3_7.jpg',
        ...
        2091: {
            ...
            icon: 'achievement_gladiator.jpg',
            label: 'Gladiator'
        },
        12945: {
            description: '',
